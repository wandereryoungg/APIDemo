...
import com.rbt.vrde.commu.DefaultRetryPolicy;
import com.rbt.vrde.commu.NetworkResponse;
import com.rbt.vrde.commu.ParseError;
...
//                VolleyLog.e("Caught OOM for %d byte image, url=%s", response.data.length, getUrl());
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (mMaxWidth == 0 && mMaxHeight == 0) {
            ...
            /*File f = new File(Environment.getExternalStorageDirectory(), "abc.png");
            try {
                FileOutputStream ops = new FileOutputStream(f);
                ops.write(data);
                ops.flush();
            } catch (Exception e) {
//                MyLog.e("ImageLoader", "---Err:" + e.getMessage(), e);
            }

//            MyLog.d("ImageLoader", "---bitmap:" + bitmap);*/
        } else {
