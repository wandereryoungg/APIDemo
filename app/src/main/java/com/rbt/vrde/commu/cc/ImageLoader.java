 ...
 *
 * The simple way to use this class is to call {@link com.rbt.vrde.commu.cc.ImageLoader#get(String, ImageListener)}
 * and to pass in the default image listener provided by
 * {@link com.rbt.vrde.commu.cc.ImageLoader#getImageListener(ImageView, int, int)}. Note that all function calls to
...
public class ImageLoader {
     ...
     * If the default was returned, the {@link com.rbt.vrde.commu.cc.ImageLoader} will be invoked when the
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        if(mUserAgent != null && mUserAgent.length() > 0) {
            newRequest.addHeader("User-Agent", mUserAgent);
        }
    ...
    public ImageLoader setUserAgent(String userAgent) {
...
//        MyLog.i("ImageLoader", "---onGetImageSuccess:" + response);
    ...
    protected void onGetImageError(String cacheKey, VolleyError error) {
        ...
        BatchedImageRequest request = mInFlightRequests.remove(cacheKey);
//        MyLog.e("ImageLoader", "---onGetImageError:" + error.getMessage(), error);
        if (request != null) {
