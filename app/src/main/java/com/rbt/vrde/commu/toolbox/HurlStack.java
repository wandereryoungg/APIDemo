...
import com.rbt.vrde.commu.Request.Method;
...
//MyLog.d("Volley", "---url:" + url);
        HttpURLConnection connection = openConnection(parsedUrl, request);
        for (String headerName : map.keySet()) {
//MyLog.i("Volley", "---header key:" + headerName + "--value:" + map.get(headerName));
            connection.addRequestProperty(headerName, map.get(headerName));
        }
        setConnectionParametersForRequest(connection, request);
//        MyLog.d("Volley", "---rsp code:" + connection.getResponseCode());
...
//MyLog.d("Volley", "---request body:" + (body != null ? new String(body) : null));
        if (body != null) {
            connection.setDoOutput(true);
