...
package com.rbt.vrde.commu.toolbox;

import android.os.SystemClock;

import com.rbt.vrde.commu.AuthFailureError;
import com.rbt.vrde.commu.Cache.Entry;
import com.rbt.vrde.commu.InternalUtils;
import com.rbt.vrde.commu.Network;
import com.rbt.vrde.commu.NetworkError;
import com.rbt.vrde.commu.NetworkResponse;
import com.rbt.vrde.commu.NoConnectionError;
import com.rbt.vrde.commu.Request;
import com.rbt.vrde.commu.RetryPolicy;
import com.rbt.vrde.commu.ServerError;
import com.rbt.vrde.commu.TimeoutError;
import com.rbt.vrde.commu.VolleyError;
import com.rbt.vrde.commu.VolleyLog;
import com.rbt.vrde.commu.http.HttpEntity;
import com.rbt.vrde.commu.http.HttpResponse;
		...
		while (true) {
			...
			try {
				...
				logSlowRequests(requestLifetime, request, responseContents,
						httpResponse);
//				MyLog.e("BasicNetwork", "---statusCode:[" + statusCode + "]--url:"+ request.getUrl());
				...
				if (httpResponse != null) {
					...
					attemptRetryOnException("noConnect", request, new NoConnectionError(e));
					continue;
				}
//				MyLog.e("BasicNetwork", "---statusCode:[" + statusCode + "]--url:"+ request.getUrl() +"\n---Err:" + e.getMessage(), e);
				if (statusCode == HttpResponse.SC_MOVED_PERMANENTLY
...
//					VolleyLog.e("Unexpected response code %d for %s", statusCode, request.getUrl());
				...
				if (responseContents != null) {
					...
					if (statusCode == HttpResponse.SC_UNAUTHORIZED || statusCode == HttpResponse.SC_FORBIDDEN) {
						attemptRetryOnException("auth", request, new AuthFailureError(networkResponse));
					} else if (statusCode == HttpResponse.SC_MOVED_PERMANENTLY || statusCode == HttpResponse.SC_MOVED_TEMPORARILY) {
	...
	private byte[] entityToBytes(HttpEntity entity) throws IOException,
		...
		try {
			...
			try {
				...
				// entity in
				// an invalid state.
//				VolleyLog.d("Error occured when calling consumingContent");
			}
